...
```
IDesignTimeDbContextFactory,工厂  
如果没有会自动查找Program里面的配置,如果写了那么就以工厂类为主.      
如果你的DBContext没有写在Web项目里面，也就是没和Program在一个项目里面，那么就需要写工程类.  
```C#
